...
weapon_shot_velocity = 7.0
enemy_weapon_shot_velocity = 5.0
...
# create display window and icon
...
# create background image and musics
...
# destroy both bullet and laser on collision
...
def init_game():
    ...
    laser_height = 24
    laser_dx = 0
    laser_dy = enemy_weapon_shot_velocity
